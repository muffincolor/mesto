export default class Card {
  ...
  generateCard() {
    ...
    this._infoSelector = this._element.querySelector('.element__info');
    this._infoSelector.querySelector('.element__title').textContent = this._name;
    this._infoSelector.querySelector('.element__likes').textContent = this._likes;
